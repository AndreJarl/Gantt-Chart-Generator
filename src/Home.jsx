...
function Home() {
  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-20 h-screen mx-5 pt-[36em] overflow-x-auto">
        <div className="flex justify-center items-center gap-3 flex-col  ">
           <p className="text-6xl font-bold text-blue-600 text-center mt-5">Welcome to ACSL Planner</p>
           ...
           <img className="w-[700px] mt-4 shadow-md rounded border" src={gant} alt="" srcset="" />
